'''Participantes: 
    ...
    Paulo Gabriel de Angelis Lemos.
    Marina de Carla Nogueira Guicioli.
    
   Ideia Inicial: 

    Um jogo simples simulador da vida real, uma espécie de protótipo de The sims.
   
   Desenvolvimento: 
    Fizemos uma brainstorm para ter uma ideia geral do programa
    Nos dividimos em estagios para acelerar o progresso do programa
        Filipe 1º Estagio
        Paulo 2º Estagio e Desenhos. 
        Marina 3º Estagio
    Solucionamos juntos problemas presentes em todo o programa para entregar a versão final.'''
...
# classe pra gerenciar o horario no estagio em que ele esta se arrumando pro trabalho
...
# classe pra gerenciar o horario no estagio em que ele esta se arrumando para ir dormir
...
# Super classe com os atributos fundamentais de quando ele acorda
...
# Super classe com os atributos fundamentais de quando ele dormi
...
# Classe que se refere ao personagem do momento que ele acorda ao momento em que vai trabalhar
...
class Personagem_manha(Acorda):
    def __init__(self):
        ...
        self.__sanidade = 100
# Estamos encapsulando o atributo sanidade

    @property
    def sanidade(self):
        return self.__sanidade
# getter da sanidade
...
# setter da sanidade
    ...
    def sanidade(self, nova_sanidade):
        raise ValueError(
            ' Para alterar a sanidade você precisa ultilizar o método altera_sanidade')

    def altera_sanidade(self, diminuir):
        self.__sanidade -= diminuir
...
# Classe que se refere ao personagem do momento em que ele sai do trabalho ao momento em que vai dormir
...
while personagem_manha.retorno() > 0:
    while True:
        dia += 1
        ...
        while dia == 2:
            ...
            if opcao == '1':
                if personagem_manha.Pagar_conta_agua == True:
                    print('Não tem água')
                    personagem_manha.altera_sanidade(2)
                ...
                print(
                    '┗━━━╨━━━━━━━━╨━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╨━━━━━━━━━┛')
                print()
                # Aqui estamos tirando a sanidade dele a cada coisa que era pra ele fazer antes de ir trabalhar e não fez
                # Sanidade também é retirada se ele atrasar
                ...
                if relogio_manha.atrasado():
                    personagem_manha.altera_sanidade(5)
                print(
                    "-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|")
                ...
                print(
                    "-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|")
                if 0 < personagem_manha.retorno() < 80:
                    print(f'{nome} terminou o primeiro estagio do jogo com a sanidade em ', personagem_manha.retorno(),
                          '%, cuidado! você não pode zerar sua sanidade!')
                if 80 <= personagem_manha.retorno() < 90:
                    print(
                        f'{nome} terminou o primeiro estagio do jogo com a sanidade em ', personagem_manha.retorno(), '%')
                if personagem_manha.retorno() >= 90:
                    print(f'{nome} terminou o primeiro estagio do jogo com a sanidade em ', personagem_manha.retorno(),
        ...
        while dia == 1 or dia == 3 or dia == 5:
            ...
            if opcao == "1":
                ...
                print("Opção inválida!")
                relogio_manha.avancaTempo(5)
        # Tornamos todas as condições como não feitas para que assim estejam no dia seguinte
        personagem_manha.sujo = True
        personagem_manha.fome = True
        ...
        # Se ele tiver com sanidade zerada ou negativa ele perde o jogo no final do estagio ue falhou
        if personagem_manha.retorno() <= 0:
            print()
            print(
                '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
            print(
        ...
        print("Precionando 0 como resposta você sai do jogo")
        ...
        # Daqui em diante definimos funções para a lista de perguntas ser perguntada
        ...
        def Quiz_teste_1(Perguntas_1):
            ...
            for Questao in Perguntas_1:
                ...
                if Resposta == Questao.Resposta:
                    ...
                    erros.append(1)
                for i in erros:
                    personagem_manha.altera_sanidade(1)
        ...
        # Chamada das funções de acordo com o dia em que estamos
        if dia == 1:
        ...
        if 0 < personagem_manha.retorno() < 50:
            print(f'{nome} terminou o segundo estagio do jogo com a sanidade em ',
                  personagem_manha.retorno(), '%, cuidado! você não pode zerar sua sanidade!')
        if 65 <= personagem_manha.retorno() < 80:
            print(f'{nome} terminou o segundo estagio do jogo com a sanidade em ',
                  personagem_manha.retorno(), '%')
        if personagem_manha.retorno() >= 80:
            print(f'{nome} terminou o segundo estagio do jogo com a sanidade em ', personagem_manha.retorno(),
                  '%'' muito bem! continue assim, deixe sua sanidade o \nmais alta possível')
        ...
        if personagem_manha.retorno() <= 0:
            ...
            print(
                '                                                                          ')
            exit()
        input('Precione enter para bater o ponto: ')
        print(
            "-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|")
        print()
        print(" Você saiu do trabalho e entrou carro: ")
        print()
        ...
        while dia == 1:
            ...
            if opcao == '1':
                ...
                if personagem_noite.ComprarRoupa == False:
                    ...
                    # Aqui estamos tirando a sanidade dele a cada coisa que era pra ele fazer antes de ir dormir e não fez
                    # Sanidade também é retirada se ele dormir tarde
                    ...
                    print(
                        "-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|-=-|")
                    if 0 < personagem_manha.retorno() < 80:
                        print(f'{nome} terminou o terceiro estagio do jogo com a sanidade em ', personagem_manha.retorno(),
                              '%, cuidado! você não pode zerar sua sanidade!')
                    if 80 <= personagem_manha.retorno() < 90:
                        print(
                            f'{nome} terminou o terceiro estagio do jogo com a sanidade em ', personagem_manha.retorno(), '%')
                    if personagem_manha.retorno() >= 90:
                        print(f'{nome} terminou o terceiro estagio do jogo com a sanidade em ', personagem_manha.retorno(),
                              '%'' muito bem! continue assim, deixe sua sanidade o \nmais alta possível')
                    break
